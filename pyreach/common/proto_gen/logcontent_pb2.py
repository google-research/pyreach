...
_LOGCONTENTPROTO = _descriptor.Descriptor(
  name='LogContentProto',
  full_name='fluxworks.g3.log.LogContentProto',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='fluxworks.g3.log.LogContentProto.id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='header', full_name='fluxworks.g3.log.LogContentProto.header', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='payload', full_name='fluxworks.g3.log.LogContentProto.payload', index=2,
...
LogContentProto = _reflection.GeneratedProtocolMessageType('LogContentProto', (_message.Message,), {
  'DESCRIPTOR' : _LOGCONTENTPROTO,
  '__module__' : 'logcontent_pb2'
  # @@protoc_insertion_point(class_scope:fluxworks.g3.log.LogContentProto)
  })
