...
_LOGENTRYBATCH = _descriptor.Descriptor(
  name='LogEntryBatch',
  full_name='juggler.LogEntryBatch',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='entries', full_name='juggler.LogEntryBatch.entries', index=0,
...
LogEntryBatch = _reflection.GeneratedProtocolMessageType('LogEntryBatch', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:juggler.LogEntryBatch)
  })
