...
class StateMetadata(google.protobuf.message.Message):
    ...
    class _TypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[StateMetadata._Type.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        UNSPECIFIED: StateMetadata._Type.ValueType  # 0
        """No extra information provided."""

        REGULAR: StateMetadata._Type.ValueType  # 1
        """State generated by the current part and output at regular intervals."""

        MERGED: StateMetadata._Type.ValueType  # 2
        """State merged from subordinate parts and output at regular intervals.
        See go/rcv2#merged-states for details.
        """

        IRREGULAR: StateMetadata._Type.ValueType  # 3
...
class CommandMetadata(google.protobuf.message.Message):
    ...
    class _Type:
        ValueType = typing.NewType('ValueType', builtins.int)
        V: typing_extensions.TypeAlias = ValueType
    class _TypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[CommandMetadata._Type.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        UNSPECIFIED: CommandMetadata._Type.ValueType  # 0
        """No extra information provided."""

        CLIENT: CommandMetadata._Type.ValueType  # 1
        """Command output from a robot client to the backend."""

        VIRTUAL: CommandMetadata._Type.ValueType  # 2
        """Command output from a virtual part to another part."""

        ECHOED_INPUT: CommandMetadata._Type.ValueType  # 3
...
class RobotCommandResult(google.protobuf.message.Message):
    ...
    """Sequence number of the command which terminated."""
...
class ControlModuleCommandProcessing(google.protobuf.message.Message):
    ...
    class _Result:
        ValueType = typing.NewType('ValueType', builtins.int)
        V: typing_extensions.TypeAlias = ValueType
    class _ResultEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[ControlModuleCommandProcessing._Result.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        UNSPECIFIED: ControlModuleCommandProcessing._Result.ValueType  # 0
        BYPASS: ControlModuleCommandProcessing._Result.ValueType  # 1
        """Command bypassed this control module (ie, ProcessCommand returned false)."""

        SUCCESS: ControlModuleCommandProcessing._Result.ValueType  # 2
        """Command was processed successfully (ie, ProcessCommand returned true)."""

        FAILURE: ControlModuleCommandProcessing._Result.ValueType  # 3
...
class SystemState(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        active_command_id: typing.Optional[builtins.int] = ...,
