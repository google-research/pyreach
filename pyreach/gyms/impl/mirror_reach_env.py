...
"""The Mirror Reach Environment class that actually does the Gym functions."""
...
from pyreach.gyms.impl.arm_device import ReachDeviceArm
from pyreach.gyms.impl.color_camera_device import ReachDeviceColorCamera
from pyreach.gyms.impl.depth_camera_device import ReachDeviceDepthCamera
from pyreach.gyms.impl.force_torque_sensor_device import ReachDeviceForceTorqueSensor
from pyreach.gyms.impl.oracle_device import ReachDeviceOracle
from pyreach.gyms.impl.reach_device import ReachDevice
from pyreach.gyms.impl.reach_device import ReachDeviceSynchronous
from pyreach.gyms.impl.server_device import ReachDeviceServer
from pyreach.gyms.impl.text_instructions_device import ReachDeviceTextInstructions
from pyreach.gyms.impl.vacuum_device import ReachDeviceVacuum


class MirrorReachEnv(gym.Env):  # type: ignore
  ...
  def __init__(self,
               pyreach_config: Optional[Dict[
                   str, reach_element.ReachElement]] = None,
    ...
    with self._timers.select({"!agent*", "gym.init"}):
      ...
      self._pyreach_config: Dict[str, reach_element.ReachElement] = (
          pyreach_config)
      self._text_instruction: Optional[ReachDeviceTextInstructions]
      self._text_instruction = None
