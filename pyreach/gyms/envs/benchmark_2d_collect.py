...
# gyms/__init__.py.
ENV_ID = "benchmark-2d-collect-v1"
...
TIMEOUT_PER_TASK_SECONDS = 10 * 60.0
...
class Benchmark2DCollectEnv(reach_env.ReachEnv):
  """Benchmark environment for the Instruction Following/2D benchmark.
  ...
  def _start_test_case(self, reward: float, info: Any) -> StepReturn:
    ...
    instr = "Hit enter to get next long horizon instruction"
