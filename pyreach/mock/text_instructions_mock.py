...
class TextInstructionMock(text_instruction.TextInstruction):
...
class TextInstructionsMock(text_instruction.TextInstructions):
  ...
  def fetch_text_instruction(
    ...
    Returns:
      Returns the latest text instruction.

    """
    mock_text_instruction: text_instructions_mock.TextInstructionMock
    mock_text_instruction = text_instructions_mock.TextInstructionMock(
        1.0, 0, "intent", "success_type", "instruction", "success_detection",
        "uid")
    return mock_text_instruction
